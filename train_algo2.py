...
def train_unimodal_ebm_algo2(decoder, train_loader, epochs=10, latent_dim=768, lr_e=0.00002, lr_g=0.0001, device='cuda'):
    ...
    """
    # Hyperparameters from explicit OCR user request setup
    K_0, a_0, K_1, a_1 = 60, 0.4, 40, 0.1
    llhd_sigma = 0.3
    # Likelihood coefficient maps to 1 / (2 * sigma^2). 
    ...
    # 2 Optimizers mimicking the structural separation from the specific snippet
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, batch in enumerate(progress_bar):
            ...
            # =======================================================
            # 3. Update Generator / Decoder w/ MSE / MLE
            # =======================================================
            optG.zero_grad()
            out = model.decoder(
            ...
            # =======================================================
            # 4. Update Energy Based Model Prior w/ CD
            # =======================================================
            optE.zero_grad()
...
# Boilerplate loading code matched identically to architecture inside `train.py`
